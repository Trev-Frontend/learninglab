...
export default function NotSureWhereToBeginSection() {
  return (
    <section className="relative w-full bg-white pt-14 sm:pt-18 pb-0 overflow-hidden">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* Intro Paragraph */}
        <p className="mt-3.5 text-[13.5px] sm:text-[14px] text-[#566e7a] max-w-[760px] mx-auto leading-[1.65] font-medium">
          Contact us for a free introductory call. We will listen to your concern and guide you towards consultation, assessment or the most relevant service.
        </p>
