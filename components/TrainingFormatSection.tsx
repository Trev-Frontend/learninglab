  ...
  return (
    <section className="relative w-full bg-white pt-10 sm:pt-14 pb-0 overflow-hidden">
      <div className="max-w-[1240px] xl:max-w-[1360px] 2xl:max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* Pill Badges Grid (Sleek, Bold & High Contrast) */}
        <div className="mt-6 sm:mt-8 flex flex-wrap justify-center items-center gap-3 sm:gap-3.5 max-w-[920px] mx-auto">
          {formats.map((fmt, idx) => (
            <span
              key={idx}
              className="bg-[#f0f6df] text-[#24450a] px-4.5 sm:px-5 py-2 sm:py-2.5 rounded-full text-[13.5px] sm:text-[14.5px] lg:text-[15.5px] xl:text-[17px] font-bold border border-[#c6e297] shadow-2xs"
            >
              {fmt}
            </span>
          ))}
