  ...
  return (
    <section className="relative w-full bg-white pt-10 sm:pt-14 pb-0 overflow-hidden">
      <div className="max-w-[1240px] xl:max-w-[1360px] 2xl:max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="mt-3.5 text-[14px] sm:text-[15px] lg:text-[16px] xl:text-[17.5px] 2xl:text-[19px] text-[#334650] max-w-[720px] mx-auto leading-[1.6] font-medium">
        ...
        <div className="mt-6 sm:mt-7 flex flex-wrap justify-center items-center gap-3 sm:gap-3.5">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-6 sm:px-7.5 py-3 lg:py-3.5 rounded-full bg-[#f15b2a] hover:bg-[#de4b1a] text-white text-[13.5px] sm:text-[14.5px] lg:text-[15.5px] xl:text-[16.5px] font-bold transition-all shadow-xs group cursor-pointer"
          >
          ...
          <Link
            href="/services"
            className="inline-flex items-center gap-2 px-6 sm:px-7.5 py-3 lg:py-3.5 rounded-full border border-[#0c3746]/20 hover:border-[#0c3746] text-[#0c3746] hover:bg-[#0c3746]/5 text-[13.5px] sm:text-[14.5px] lg:text-[15.5px] xl:text-[16.5px] font-bold transition-all group cursor-pointer"
          >
