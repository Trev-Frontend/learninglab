      ...
      <div className="max-w-[1240px] xl:max-w-[1360px] 2xl:max-w-[1480px] mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group flex-shrink-0">
          ...
          <div className="flex flex-col">
            <span className={`text-[17px] sm:text-[18px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] font-extrabold tracking-tight leading-none ${isPurple ? "text-white" : "text-[#0c3746]"}`}>
              Learning Lab
            </span>
            <span className={`text-[8.5px] sm:text-[9.5px] lg:text-[10px] xl:text-[11px] 2xl:text-[12px] font-medium leading-tight mt-0.5 ${isPurple ? "text-white/80" : "text-[#566e7a]"}`}>
        ...
        <nav className="hidden lg:flex items-center gap-5 xl:gap-8 text-[13.5px] lg:text-[14.5px] xl:text-[16.5px] 2xl:text-[18px] font-semibold">
          <Link
            href="/"
          ...
          <div className="relative group py-2">
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-[260px] bg-white rounded-2xl shadow-xl border border-black/5 py-2.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              {servicesList.map((service, idx) => (
                <Link
                  key={idx}
                  href={service.href}
                  className="block px-4 py-2.5 text-[13px] xl:text-[14.5px] font-semibold text-[#0c3746] hover:bg-[#f5f8df] hover:text-[#f15b2a] transition-colors"
                >
                  {service.name}
                </Link>
              ))}
        ...
        <div className="hidden sm:flex items-center">
          <Link
            href="/contact"
            className="inline-flex items-center gap-1.5 bg-[#f15b2a] hover:bg-[#de4b1a] text-white px-5 lg:px-6 xl:px-8 py-2 lg:py-2.5 xl:py-3.5 rounded-full text-[12.5px] lg:text-[14px] xl:text-[16px] 2xl:text-[17.5px] font-bold shadow-xs hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 group"
          >
