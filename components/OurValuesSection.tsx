      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative flex justify-center items-center">
            ...
            {/* Collage Container */}
            <div className="relative w-full max-w-[460px] h-[380px] sm:h-[430px]">
              ...
              <div className="absolute right-[4%] sm:right-[6%] -top-4 sm:-top-6 w-[42px] sm:w-[50px] pointer-events-none z-30 rotate-12 animate-crown">
                <Image
              ...
              {/* Image 1: Top Left Sensory Gym Room */}
              <div className="absolute left-[8%] top-0 w-[48%] h-[56%] rounded-[20px] sm:rounded-[24px] overflow-hidden shadow-md z-10">
                <Image
                  src="/images/3b83111c5b2520f22ff8dc201c50b09c9532fd29.jpg"
                  alt="Sensory gym room with hammock and ladder"
                  fill
                  sizes="260px"
              ...
              {/* Image 2: Bottom Left Yellow Table with Toys */}
              <div className="absolute left-0 bottom-0 w-[50%] h-[50%] rounded-[20px] sm:rounded-[24px] overflow-hidden shadow-md z-10">
                <Image
                  src="/images/570e872b69c48891eb76831b5861d6945ea4c67e.jpg"
                  alt="Yellow curved table with building blocks"
                  fill
                  sizes="240px"
                  className="object-cover"
                />
