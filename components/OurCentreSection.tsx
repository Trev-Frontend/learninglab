  ...
  return (
    <section className="relative w-full bg-white pt-16 sm:pt-20 pb-0 overflow-hidden">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* Intro Paragraph */}
        <p className="mt-4 text-[13.5px] sm:text-[14px] text-[#566e7a] max-w-[760px] mx-auto leading-[1.65] font-medium">
        ...
        <div className="mt-7 flex flex-wrap justify-center items-center gap-3.5">
          ...
          <Link
            href="/services"
            className="inline-flex items-center gap-2 border-2 border-[#0c3746] text-[#0c3746] hover:bg-[#0c3746]/5 px-6 py-2 rounded-full text-[11px] font-bold transition-all duration-200 group"
          >
